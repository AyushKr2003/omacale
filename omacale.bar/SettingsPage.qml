...
ColumnLayout {
  ...
  readonly property var files: ({
    ...
    preview: "StylePreview.qml", seeds: "SeedPicker.qml", logoPicker: "LogoPicker.qml", keybinds: "KeybindsCard.qml", lock: "LockCard.qml", looknfeel: "LookNFeelCard.qml", about: "AboutCard.qml",
